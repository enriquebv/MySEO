...
function myseo_info()
{
    ...
    if (strstr($archivo_formateado, $cadena_buscada)) {
        $comprobado = "<br/><span style=\"color:green\"><img src=\"{$mybb->settings['bburl']}/inc/plugins/myseo/imagenes/protegido.gif\"/> ".$lang->sistema_nofollow_activado."</span>";
    } else {
        $comprobado = "<br/><span style=\"color:red\"><img src=\"{$mybb->settings['bburl']}/inc/plugins/myseo/imagenes/desprotegido.gif\"/> ".$lang->sistema_nofollow_noactivado_primero."</span> <a href=\"https://github.com/BitLiberal/MySEO/blob/master/README.".$lang_docs.".md".$sistema_nofollow."\" target=\"_blank\">".$lang->sistema_nofollow_noactivado_segundo."</a>";
    }
    
    // Info del plugin
    return array(
        "name" => "MySEO",
        "description" => "<br/><div style=\"background:#FFF;padding:5px;border-radius:5px;\">".$lang->descripcion_suite."<br/>".$enlace_ajustes."".$comprobado."</div><b style=\"font-size:12px;\">".$lang->Cafe."</b>
...
function myseo_install()
{
    ...
    $setting = array(
        ...
        'description' => $lang->idAnalytics_descripcion.'<br/><br/> <b style="font-size:16px;color:#27AE60;">'.$lang->bien.'</b> <span style="background:#FFF;padding:0px 5px;border:1px solid #D9D9D9;border-radius:5px;font-family:Courier;" >UA-000000-01</span>',
        'optionscode' => 'text',
        'disporder' => '9',
        'gid' => intval($gid)
    );
