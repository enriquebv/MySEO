...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">';
    ...
    foreach($items as $item)
    {
		...
		// ORIGINAL: $output[] = "  </$tag>";
		/* Sistema de prioridad INICIO */
		if ($tag=="url"){
		global $settings;
		$cfseo = $settings['smChangeFreq'];
		$pseo = $settings['smPriority'];
		$output[] = "  <changefreq>$cfseo</changefreq>\r\n<priority>$pseo</priority>\r\n</$tag>";
		} else {
		$output[] = "  </$tag>";
		}
		/* Sistema de prioridad FIN */
    }
